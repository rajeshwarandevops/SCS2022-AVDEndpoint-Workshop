...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/jakewalsh90/SCS2022-AVDEndpoint-Workshop/main/DemoLab-Individual/PowerShell/baselab_LabStructure.ps1" -OutFile "C:\BaselabSetup\baselab_LabStructure.ps1"
