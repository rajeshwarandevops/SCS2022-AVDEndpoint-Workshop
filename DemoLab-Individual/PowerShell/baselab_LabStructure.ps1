#Setup Variables
$DCRoot = "DC=avd,DC=lab"
$LabDCRoot = "OU=Lab,DC=avd,DC=Lab"
#Create Root Lab OU
...
New-ADOrganizationalUnit -Name "WVD" -Path $LabDCRoot -ProtectedFromAccidentalDeletion $False -Description "Lab AVD Session Hosts"
